...
TOOL_TAGS = {"bash", "python", "web_search", "web_fetch", "read_file", "write_file",
             "read_project_file", "write_project_file", "run_project_script",
             ...
             "edit_image", "trigger_research", "manage_research", "search_vault", "search_knowledge", "search_zotero", "compare_papers",
