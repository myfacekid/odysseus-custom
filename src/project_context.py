...
def build_project_session_preamble(
    ...
    *,
    ...
    header = (
        ...
        "`run_project_script`, `promote_project_file` |\n"
        ...
        "(`write_project_file`). Promote a cwd file into Library with "
        "`promote_project_file` when the user wants it in Documents/Notes/corpus "
        "(explicit — never auto-sync trees). Long-form Library content → document "
        "tools (optionally link the doc to this project). Literature → graph / "
