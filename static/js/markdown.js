...
function initMermaid() {
  if (!window.mermaid || window.__nobodyMermaidReady) return;
  window.mermaid.initialize({ startOnLoad: false, theme: 'dark', securityLevel: 'loose' });
  window.__nobodyMermaidReady = true;
}
window.nobodyInitMermaid = initMermaid;
initMermaid();
...
const THINK_EXPANDED_KEY = 'nobody-thinking-expanded';
