...
async function _createAndAppendPane(m) {
  ...
  if (state._blindMode && n > 2) {
    ...
    if (shuffleBtn) {
      ...
      bubble.style.cssText = 'position:absolute;top:100%;right:0;margin-top:6px;background:var(--panel);border:1px solid var(--border);border-radius:2px;padding:5px 10px;font-size:11px;white-space:nowrap;z-index:10000;box-shadow:2px 2px 0 color-mix(in srgb, var(--fg) 18%, transparent);pointer-events:none;opacity:0;transition:opacity 0.2s;';
