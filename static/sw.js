// static/sw.js — Nobody PWA Service Worker
// Strategy:
...
const CACHE_NAME = 'nobody-v3-20260801b-chat-syntax';
...
self.addEventListener('fetch', (e) => {
  ...
  // HTML navigation: network-first so deploys / debug fixes are not stuck
  // behind a stale app-shell cache (was stale-while-revalidate).
