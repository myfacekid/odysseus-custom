...
def _load_dispatcher():
    path = Path(__file__).resolve().parent.parent / "scripts" / "nobody"
    loader = importlib.machinery.SourceFileLoader("nobody_dispatcher_under_test", str(path))
