"""scripts/_lib/cli.py — shared scaffolding for the `nobody-*` CLIs.
...
parents-parser pattern. Usage:
    ...
    def build_parser():
        p = common_parser("nobody-foo", "Description.")
...
# Make repo root importable. Tools are invoked as `scripts/nobody-foo`
...
VERSION = "0.1.0"  # bumped centrally; every nobody-* CLI reports this
