...
async def dispatch_reminder(
    ...
    email_error = ""
    if channel == "email":
        # Legacy channel — email delivery removed; fall through to browser notification.
        email_error = "Email reminders are no longer supported; using browser notification."
        channel = "browser"
