...
Nobody is not finished yet. It works great for me (lol), but this project is moving fast and feedback/help would be appreciated! (I don't know what I'm doing, help).
...
- **Deep Research overhaul (Links + Zotero + web):** Evidence registry, unified
  tool context, seed papers / similar work, and academic report quality.
